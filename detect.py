...
def detect(img_path):
    source, weights, view_img, save_txt, imgsz, trace = img_path, ["yolov7x.pt"], False, False, 640, True
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        # Apply NMS
        pred = non_max_suppression(pred, 0.25, 0.45, classes=[16], agnostic=False)
...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        detect(img_path="/home/sankalp/Practice/Navneet/Train_Dataset/golden_retriever/9c010ac92006c01fd68602e4a896ba28.jpg")
